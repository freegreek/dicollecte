...
$template->SetPageVars($_GET['prj'], 'faq', $dbaUsers);
$template->SetTrunkVar('TAB_TITLE', $ui['tabs']['faq']);

// we load the page
$mainleft = file_get_contents('./html/' . $_GET['prj'] . '/faq-left.div.html');
$mainright = file_get_contents('./html/' . $_GET['prj'] . '/faq-right.div.html');
